...
proof systems (\href{https://arxiv.org/abs/2604.16471}{arXiv:2604.16471}, 2026), which
identifies a `semantic bottleneck' arising
...
standard\footnote{RTCA DO-178C, \emph{Software Considerations in Airborne Systems and Equipment
Certification}. RTCA, Inc., 2011. \href{https://www.rtca.org/do-178/}{rtca.org/do-178}} did
not make programmers more capable; it made their capability more reliably usable. The
medical device industry's IEC
62304\footnote{IEC 62304, \emph{Medical device software: Software life cycle processes}.
International Electrotechnical Commission, 2006 (rev.\ 2015).
\href{https://www.iso.org/standard/38421.html}{iso.org/standard/38421.html}}
...
Software
Construction},\footnote{B.~Meyer, \emph{Object-Oriented Software Construction}, 2nd ed.\ Prentice Hall,
1997. \href{https://bertrandmeyer.com/OOSC2/}{bertrandmeyer.com/OOSC2}} was
...
tradition\footnote{D.~Jackson, \emph{Software Abstractions: Logic, Language, and Analysis}. MIT
Press, 2006 (rev.\ 2012). \href{https://alloytools.org/book.html}{alloytools.org/book.html}}
...
systems,\footnote{L.~Lamport, `Time, Clocks, and the Ordering of Events in a Distributed System,'
\emph{Communications of the ACM} 21(7):558--565, 1978
(\href{https://lamport.azurewebsites.net/pubs/time-clocks.pdf}{lamport.azurewebsites.net/pubs/time-clocks.pdf});
and the TLA+ specification language
(\href{https://lamport.azurewebsites.net/tla/tla.html}{lamport.azurewebsites.net/tla/tla.html}).} from
...
\pullquote{The cost of engineering discipline fell. The need for it rose.}
...
\pullquote{A validation gate is the one moment intent and output are held in the same
frame and compared. Everything upstream is preparation for it.}
...
computing\footnote{P.~Deutsch et al., `The Fallacies of Distributed Computing,' Sun Microsystems,
1994--97.
\href{https://en.wikipedia.org/wiki/Fallacies_of_distributed_computing}{en.wikipedia.org/wiki/Fallacies\_of\_distributed\_computing}}
...
as medium, the retrieval layer, the prompt construction, and the validation gates, which
together form the engineered information environment that makes the partnership productive. The
...
\pullquote{This is old engineering, applied at last to the medium that has needed it most.}
...
% ============================================================
\newpage
\section*{Drafting and Verification}

\noindent This paper was drafted with substantial assistance from several AI systems, under
the author's direction and across many revision cycles. The models spanned the United States
and China, open weight and closed: Claude Opus~4.8 and Fable~5, ChatGPT Sol~5.6, Qwen~3.6 27B
and Qwen~3.7 Max, Kimi~K3 Max, and GLM~5.2. Generation was delegated. Judgment was not. The
author reviewed every claim, scoped each to what the cited work supports, verified the
arithmetic that appears in the text, and takes sole responsibility for the argument. The
drafting process is in version control, attributable to the character, which is the record
the paper argues for. It was produced under the discipline it describes.
...
\noindent\textit{An extended bibliography, numbered independently of the inline citation
markers; those resolve to the footnotes, not to the entries below.}
