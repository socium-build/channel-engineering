...
### Task 3.2: Never retry 4xx except 429

**Acceptance criteria**

- [ ] No status in 400-499 is retried, except 429.
- [ ] A named check proves it: `test_no_retry_on_4xx`.

**Evidence to submit**

- `retry_policy_checks` (produced): output must contain `test_no_retry_on_4xx PASSED`.

**Gate:** independent checker; evidence produced by the gate, not submitted.
